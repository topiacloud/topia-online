...
define(["../common/data"], function (data) {
    ...
    var Touch = function () {
        ...
        // Options: "canvas", "camera", "region", "sprite"
        this.type = "";
        ...
        // If the type is "canvas": x is the offset from the top-left of the canvas
        ...
        // If the type is "canvas": y is the offset from the top-left of the canvas
